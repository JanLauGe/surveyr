...
surveyid = '4253549'
api =  paste0(api_token[1], '&api_token_secret=', api_token[2])
completes_only = TRUE
verbose = TRUE
var_name_append = TRUE
mergecampaign = FALSE
delete_sys_vars = FALSE
keep_geo_vars = TRUE
clean = FALSE
...
### &resultsperpage=100&filter[field][0]=status&filter[operator][0]==&filter[value][0]=Complete&page=1"
